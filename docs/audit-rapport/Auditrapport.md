...
De audit bestrijkt het volledige projecttraject (workshops WS01 t/m WS06), met als eindmeting de scanresultaten en codestatus van **18-19 juni 2026**.
...
|---|---|---|---|---|
| B-001 | Ontbrekende audit-logging bij inzage/wijziging patiëntgegevens | Hoog (contextueel) | 8.15 Logregistratie | **Opgelost** |
| B-002 | SQL-injectie via string-concatenatie in databasequery's | Kritiek | 8.28 Veilig programmeren | **Opgelost** |
| B-003 | Padmanipulatie (path traversal) bij lezen van formulierbestanden | Hoog | 8.28 Veilig programmeren | **Opgelost** |
...
Hieronder worden de vier kernbevindingen (B-001 t/m B-004) volgens het vaste auditformat uitgewerkt; B-005 en B-006 zijn als aanvullende observaties opgenomen.
...
Een gebruikersgestuurd bestandspad werd gebruikt om bestanden op het OpenMRS-serverbestandssysteem te lezen, zonder validatie van het uiteindelijke pad. Hoewel toegang beperkt was tot gebruikers met de privilege *Manage Forms*, hadden deze gebruikers hierdoor potentieel toegang tot bestanden buiten de bedoelde formulierdirectory.
...
| Beveiligingsupdates leveren gedurende de levensduur | 8.8 Patchmanagement | Dependabot actief; geen geautomatiseerd patchbeleid voor majeure versies |
