...
| --------------------------------------------------------------------------- | -------------------------------------------------------- |
| Traceability matrix (NEN-7510 control → maatregel → vóór → aanpassing → na) | [Traceability matrix](../overige/Traceability-Matrix.md) |

_Beschikbare bron in project:_ `docs/overige/Traceability-Matrix.md`
...
_Beschikbare bronnen in project:_ `artifacts/sbom-cyclonedx-anchore/sbom.cyclonedx.json`
...
| Dependabot alerts log                 | [Depandabot Alert Logs](../audit-rapport/images/Dependabot.png)         |
| JaCoCo coverage-rapport (per module)  | [JaCoCo coverage-rapport](artifacts/coverage-report/)                   |

_Beschikbare bronnen in project:_ `artifacts/codeql-sarif/java.sarif`, `artifacts/OSV Scanner SARIF file/results.sarif`, `artifacts/coverage-report/`
...
_Beschikbare bronnen in project:_ `docs/overige/Risicomatrix/`, `docs/overige/Security-Requirements.md`, `docs/overige/RiskAssesmentRapport.md`
...
_Beschikbare bronnen in project:_ `docs/overige/Bow-Ties/`, `docs/overige/Threat model/`
...
_Beschikbare bronnen in project:_ `docs/overige/Pentesting/`
...
_Beschikbare bron in project:_ `docs/overige/gapAnalyse.md`
